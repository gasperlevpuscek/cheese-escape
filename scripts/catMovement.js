...
function drawCat() {
    ...
    for (var i = 0; i < mazePolylinePoints.length; i++) {
        var scaledX = mazePolylinePoints[i].x * canvas.width / ORIGINAL_WIDTH;
        var scaledY = mazePolylinePoints[i].y * canvas.height / ORIGINAL_HEIGHT;
        var drawX = scaledX - CAT_SIZE / 2;
        var drawY = scaledY - CAT_SIZE / 2;

        canvasContext.fillRect(drawX, drawY, 20, 20);
    }
